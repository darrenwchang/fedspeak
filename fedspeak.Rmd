...
Our exercise is similar to what the New York Fed does in their w[weekly nowcasting report](https://www.newyorkfed.org/research/policy/nowcast.html), although limited access to data constrains the forecast's timeliness. In addition, the method chosen for nowcasting does not use Kalman filtering.
